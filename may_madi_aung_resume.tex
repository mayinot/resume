...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        {Connected ERP, MES, PLM, and IoT sensors via NiFi and Node-RED.}
        \resumeItem{Kafka Streaming}
        {Streamed processed data to a Data Lake using Kafka topics for Agentic AI consumption.}
        \resumeItem{Cloud Native Deployment}
        {Containerized backend services using Docker and automated deployment with Kubernetes and Helm.}
    \resumeItemListEnd
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItem{SharePoint Automation}
        {Automated the TS Audit Portal on SharePoint, reducing audit time by 30\% and enabling greater focus on critical tasks.}      
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Data Analytic Dashboard (NHGP Polyclinic)}
    ...
    \resumeSubItem{Hotel Concierge Web Portal (SIT)}
    ...
    \resumeSubItem{Pentesting Tool (DSO National Laboratories)}
